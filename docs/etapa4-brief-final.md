...
| IA narrativa | Azure foundry GPT4.1 API |
| Generación de imágenes | Azure foundry — Flux.2-PRO |
...
- **Criterios de Aceptación:**
  ...
  - [ ] Variables de entorno definidas y documentadas para todas las API keys (Azure froundry gpt4.1, ElevenLabs, Azure froundry Flux.2-PRO, Stripe).
...
- **Título:** Integrar Azure foundry gpt4.1 API, Azure froundry Flux.2-PRO y ElevenLabs en el backend NestJS
...
- **Criterios de Aceptación:**
  ...
  - [ ] Endpoint POST `/generate/images` recibe descripción de escena + estilo y retorna URL de imagen usando Azure froundry Flux.2-PRO.
