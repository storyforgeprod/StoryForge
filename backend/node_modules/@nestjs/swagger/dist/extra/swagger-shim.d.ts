...
export declare function ApiTagOptions(): () => void;
...
export declare function DeepPartialType(): {
    new (): {};
};
...
export declare const ApiPropertyOptions: {};
export declare const OpenAPIObject: {};
